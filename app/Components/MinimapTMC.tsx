...
export default function MinimapTMC() {
      ...
      <View style={{width: VIEW_W, height:VIEW_H-90}}>
        <Animated.View style={styles.box} {...pan.panHandlers}>
          <Svg width={VIEW_W} height={VIEW_H} viewBox={`${vx} ${vy} ${vw} ${vh}`}>
                  ...
                  <G id="interchanges">
                    {/* 50,550 - 50,551 */}
                    <Line x1={50} y1={550} x2={50} y2={551} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={50} y1={550} x2={50} y2={551} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 150,550 - 150,551 */}
                    <Line x1={150} y1={550} x2={150} y2={551} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={150} y1={550} x2={150} y2={551} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 250,550 - 250,551 */}
                    <Line x1={250} y1={550} x2={250} y2={551} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={250} y1={550} x2={250} y2={551} stroke="white" strokeWidth={15} strokeLinecap="round" />
