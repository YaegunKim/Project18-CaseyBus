...
export default function MinimapHovey() {
      ...
      <View style={{width: VIEW_W, height:VIEW_H-90}}>
        <Animated.View style={[styles.box, {backgroundColor: '#f5f7f6'}]} {...pan.panHandlers}>
          <Svg width={VIEW_W} height={VIEW_H} viewBox={`${vx} ${vy} ${vw} ${vh}`}>
                  ...
                  <G id="interchanges">
                    {/* 50,570 - 50,571 */}
                    <Line x1={50} y1={570} x2={50} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={50} y1={570} x2={50} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 150,570 - 150,571 */}
                    <Line x1={150} y1={570} x2={150} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={150} y1={570} x2={150} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 250,570 - 250,571 */}
                    <Line x1={250} y1={570} x2={250} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={250} y1={570} x2={250} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 350,570 - 350,571 */}
                    <Line x1={350} y1={570} x2={350} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={350} y1={570} x2={350} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 520,570 - 520,571 */}
                    <Line x1={520} y1={570} x2={520} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={520} y1={570} x2={520} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 620,570 - 620,571 */}
                    <Line x1={620} y1={570} x2={620} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={620} y1={570} x2={620} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
            
                    {/* 720,570 - 720,571 */}
                    <Line x1={720} y1={570} x2={720} y2={571} stroke="black" strokeWidth={18} strokeLinecap="round" />
                    <Line x1={720} y1={570} x2={720} y2={571} stroke="white" strokeWidth={15} strokeLinecap="round" />
                  </G>
                  ...
                  {/* Buses */}
                    {runningBuses.map((item:[Route,number[]], index) => {
                      if (item[0] !== routeHovey) return null
                    return(
